...
class PluginDatabaseinventoryDatabaseParam extends CommonDBTM
{
    ...
    public function rawSearchOptions()
    {
        ...
        $tab[] = [
            ...
            'name'               => __('Execution delay for partial inventory', 'databaseinventory'),
            'datatype'           => 'number',
            'min'                => 0,
            'max'                => 24,
            'step'               => 1,
    ...
    public function showForm($ID, array $options = [])
    {
        ...
        echo "<td><label for='is_active$rand'>" . __('Execution delay for partial inventory', 'databaseinventory') . "</label></td>";
        echo "<td>";
        Dropdown::showNumber(
            'execution_delay',
            [
